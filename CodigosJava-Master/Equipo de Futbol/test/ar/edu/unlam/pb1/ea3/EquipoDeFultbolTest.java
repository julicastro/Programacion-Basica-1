...
//import ar.edu.unlam.pb1.ea3.CapacidadMaximaException;
import ar.edu.unlam.pb1.ea3.EquipoDeFutbol;
import ar.edu.unlam.pb1.ea3.Jugador;
//import ar.edu.unlam.pb1.ea3.JugadorDuplicadoException;
//import ar.edu.unlam.pb1.ea3.JugadoreInexistenteException;
...
public class EquipoDeFultbolTest {
	...
	public void queSePuedaCrearUnEquipoVacio() {
		...
		assertNull(losJugadoresDelNapoli[0]);
	...
	public void queCalculaBienElPrecioPromedio(){
		...
		assertEquals(10000.0, argentina.calcularElPrecioPromedio(), 0.01);
	}
}
